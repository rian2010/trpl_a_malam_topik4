...
<tbody class="table-group-divider">
	...
	?>
		<tr>
				...
				<td>
                    <a type="button" class="btn btn-primary" href="form_update.php?id_alat=<?php echo $data['id_alat'];?>" >Edit</a><br>
					<a  type="button"class="btn btn-danger" href="hapus_fasil.php?id_alat=<?php echo $data['id_alat']; ?>">hapus</a>
