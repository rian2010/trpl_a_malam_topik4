...
<div class="modal fade" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="card-body">
	...
	<table class="table table-hover table-bordered" id="datatable9">
<thead>
		<tr>
			<th>No</th>
			<th>Ruangan</th>
...
")or die(mysqli_error());
		...
		<tr>
			...
			<td>
			<a  type="button"class="btn btn-primary" href="form_edit_ruang.php?id_ruangan=<?php echo $data['id_ruangan']; ?>">
				<i class="fa-solid fa-pen-to-square"></i>
			</a>
			<a  type="button"class="btn btn-danger" href="hapus_ruang.php?id_ruangan=<?php echo $data['id_ruangan']; ?>">
